...
// DirMapping represents a source to destination directory mapping
type DirMapping struct {
	Source      string
	Destination string
}

// NameMapping represents an old name to new name mapping for renaming
type NameMapping struct {
	OldName string
	NewName string
}

// RewriteRule represents a rule for rewriting file contents
...
// ParseAndValidate parses command line arguments and validates them
